...
client.once(Events.ClientReady, c => console.log(`◆ NEXUS online as ${c.user.tag} (${c.guilds.cache.size} guilds)`));

client.on(Events.InteractionCreate, async i => {
  try {
    if (i.isChatInputCommand() && i.commandName === 'nexus') return handleNexusCommand(i);
