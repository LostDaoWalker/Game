...
const cmd = new SlashCommandBuilder().setName('tianming').setDescription('Launch TIANMING — Cultivate. Ascend. Transcend.');
...
rest.put(route, { body: [cmd.toJSON()] }).then(() => console.log(`✓ /tianming deployed — ${mode}`)).catch(e => { console.error(e); process.exit(1); });
